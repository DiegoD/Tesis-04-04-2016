 ...
 *
 */
public class ReciboVO extends DatosDocumVO{

private ArrayList<ReciboDetalleVO> detalle;
	...
	public ReciboVO(){
		...
		this.detalle = new ArrayList<ReciboDetalleVO>();
	}
	
	public void copiar(ReciboVO t){
		...
		ReciboDetalleVO aux;
		for (ReciboDetalleVO detVO : t.detalle) {
			
			aux = new ReciboDetalleVO();
			aux.copiar(detVO);
	...
	public ArrayList<ReciboDetalleVO> getDetalle() {
		return detalle;
	}

	public void setDetalle(ArrayList<ReciboDetalleVO> detalle) {
