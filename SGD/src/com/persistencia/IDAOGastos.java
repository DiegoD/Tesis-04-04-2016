...
public interface IDAOGastos {
	...
	public ArrayList<Gasto> getGastosConSaldo(Connection con, String codEmp, String codTit, String codMoneda) throws ObteniendoGastosException, ConexionException;
}
