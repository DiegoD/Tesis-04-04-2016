...
public class DAOEgresoCobro implements IDAOEgresoCobro{
  
	/**
	 * Nos retorna una lista con todos los egresos de cobro del sistema para la emrpesa
	 */
	public ArrayList<IngresoCobro> getEgresoCobroTodos(Connection con, String codEmp, Timestamp inicio, Timestamp fin) throws ObteniendoEgresoCobroException, ConexionException {
		...
		try {
	    	...
	    	String query = clts.getEgresoCobroCabTodos();
			...
			throw new ObteniendoEgresoCobroException();
	...
	/**
	 * Nos retorna una lista con todos los egresos de cobro otros del sistema para la emrpesa
	 */
	public ArrayList<IngresoCobro> getEgresoCobroOtroTodos(Connection con, String codEmp, Timestamp inicio, Timestamp fin) throws ObteniendoEgresoCobroException, ConexionException {
		...
		try {
			//
	    	Consultas clts = new Consultas();
	    	String query = clts.getEgresoOtroCobroCabTodos();
	    	PreparedStatement pstmt1 = con.prepareStatement(query);
	...
	public boolean memberEgresoCobro(int nroDocum, String codEmp, Connection con) throws ExisteEgresoCobroException, ConexionException{
		...
		try{
			...
			String query = consultas.memberEgresoCobro();
	...
	public boolean existeEgreso(int nroDocum, String codEmp, Connection con) throws ExisteEgresoCobroException, ConexionException{
		...
		try{
			...
			Consultas consultas = new Consultas();
			String query = consultas.existeEgresoCobro();
	...
	public void insertarEgresoCobro(IngresoCobro cobro, Connection con) throws InsertandoEgresoCobroException, ConexionException {
    	...
    	String insert = clts.insertEgresoCobroCab();
    	...
    	try {
			...
			for (IngresoCobroLinea lin : cobro.getDetalle()) {
				...
				this.insertarLineaEgreso(lin, linea, con);
	 ...
	 * @throws EliminandoNotaCreditoException 
	 *
	 */
	public void eliminarEgresoCobro(IngresoCobro cobro, Connection con) throws InsertandoEgresoCobroException, ConexionException, EliminandoEgresoCobroException {
		...
		Consultas clts = new Consultas();
    	String delete = clts.eliminarEgresoCobroCab();
	 ...
	 *
	 */
	private void eliminarEgresoCobroDetalle(IngresoCobro cobro, Connection con) throws  ConexionException, EliminandoEgresoCobroException {

		Consultas clts = new Consultas();
    	String delete = clts.deleteEgresoCobroCabDet();
	 ...
	 * 
	 */
	private void insertarLineaEgreso(IngresoCobroLinea lin, int linea, Connection con) throws InsertandoEgresoCobroException, ConexionException {

		Consultas clts = new Consultas();
    	
    	String insert = clts.insertEgresoCobroCabDet();
...
/////////////////////////////////////DETALLE/////////////////////////////////////////////////////
	 ...
	 */
	private ArrayList<IngresoCobroLinea> getEgresoCobroLineaxTrans(Connection con, IngresoCobro cab) throws ObteniendoEgresoCobroException, ConexionException {
		...
		try {
	    	...
	    	Consultas clts = new Consultas();
	    	String query = clts.getEgresoCobroDetxTrans();
	    	PreparedStatement pstmt1 = con.prepareStatement(query);
