...
public class VistaSaCuentasExtended extends VistaSaCuentas {

	private ArrayList<SaCuentasVO> lstGastos; 
	private BeanItemContainer<SaCuentasVO> container;
	private VistasControlador controlador;
	MySub sub = new MySub("50%","65%");
	PermisosUsuario permisos;
	boolean actualiza = false;
	
	public VistaSaCuentasExtended(){
		
		controlador = new VistasControlador();
		this.lstGastos = new ArrayList<SaCuentasVO>();
	...
	private void inicializarGrilla() throws InstantiationException, IllegalAccessException, ClassNotFoundException, FileNotFoundException, IOException{
		...
		this.container = 
				new BeanItemContainer<SaCuentasVO>(SaCuentasVO.class);
		...
		for (SaCuentasVO gastoVO: lstGastos) {
	 ...
	 *
	 */
	private ArrayList<SaCuentasVO> getGastos() throws Exception  {
		
		ArrayList<SaCuentasVO> lstGastos = new ArrayList<SaCuentasVO>();
		...
		try {
			...
			lstGastos = controlador.getSaCuentas(permisoAux.getCodEmp());
