...
public class GtosPendCobroxClienteViewExtended extends GtosPendCobroxClienteViews implements IBusqueda, IMensaje{
	...
	public GtosPendCobroxClienteViewExtended(){
			    ...
			    report = new ReportsUtil();
				  ...
				  try {
					  ...
					  try{
						...
						StreamResource myResource = report.prepareForPdfReportReturn( basepath+"/RepGtosPendCobroxClientes.jrxml",
									                "GastosPendientes",
									                fillParameters);
