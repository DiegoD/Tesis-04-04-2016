...
public class ResProcesosPanelExtended extends ResProcesosPanel{
	
	private ResumenProcesoViewExtended form; 
	...
	public ResProcesosPanelExtended(){
		controlador = new ResumenProcesoControlador();
		this.lstProcesos = new ArrayList<ProcesoVO>();
		this.lblTitulo.setValue("Resumen procesos");
		...
		boolean permisoLectura = permisos.permisoEnFormulaior(VariablesPermisos.FORMULARIO_RESUMEN_PROCESO, VariablesPermisos.OPERACION_LEER);
		...
		if(permisoLectura){
			...
			try {
				...
				boolean permisoNuevoEditar = permisos.permisoEnFormulaior(VariablesPermisos.FORMULARIO_RESUMEN_PROCESO, VariablesPermisos.OPERACION_NUEVO_EDITAR);
