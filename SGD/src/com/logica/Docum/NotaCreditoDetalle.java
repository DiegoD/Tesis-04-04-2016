...
public class NotaCreditoDetalle extends DocumDetalle {

	public NotaCreditoDetalle(NotaCreditoDetalleVO t) {
		super(t);
	}
	...
	public NotaCreditoDetalleVO retornarVO(){
	
		
		NotaCreditoDetalleVO aux = new NotaCreditoDetalleVO();
